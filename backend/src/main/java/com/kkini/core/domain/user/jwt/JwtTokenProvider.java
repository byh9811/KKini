package com.kkini.core.domain.user.jwt;

import com.kkini.core.domain.user.config.ExpireTime;
...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${kkini_jwt_secret_key}") String secretKey) {
