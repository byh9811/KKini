...
INSERT INTO MEMBER(create_date_time, modify_date_time, auth_provider, email, image, level, name, nickname, oauth2id, refresh_token, role, stars) VALUES (now(), now(), 'NAVER', 'byh9811@google.com', 'https://kkini.s3.ap-northeast-2.amazonaws.com/profile/%EB%B3%91%EC%9A%B1.png', 3, '김범창', 'tigerspear', 'oauth2id2', 'token67890', 'ROLE_USER', 2);
