  ...
  return (
    <div className="uploader-wrapper">
      <div>
        ...
        <button className="btnn" onClick={(e) => e.target.previousSibling.click()}>사진 업로드</button>
      </div>
      ...
      <div>
        <label>필요 재료</label>
        <br />
        <textarea className="mx-auto" name="" id="" cols="30" rows="5" value={materialValue} onChange={(e) => setMaterialValue(e.target.value)}></textarea>
      </div>
      <br />
      ...
      <div>
        <label>내용 입력</label>
        <br />
        <textarea className="mx-auto" name="" id="" cols="30" rows="5" value={contentValue} onChange={(e) => setContentValue(e.target.value)}></textarea>
      </div>
      <br />

      <div>
        <button className="btnn" onClick={handleFileUpload} style={{marginBottom: '60px'}}>파일 업로드</button>
      </div>
    </div>
  );
}
